...
- (void)viewDidLoad {
    ...
    self.tableViewItems = @[@"HZWeiBoMainViewController",@"HZEstimateRowHeightViewController",@"HZLightViewController",@"HZListLinkViewController",@"HZEnumTableViewController"];
}
