...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        [self.tapButton addTarget:self action:@selector(ignoreUninterestingItem) forControlEvents:UIControlEventTouchUpInside];
...
-(void)ignoreUninterestingItem{
    if (self.ingoreUnInterestingItemBlock) {
